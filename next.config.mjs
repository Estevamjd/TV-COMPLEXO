        ...
        headers: [
          ...
          { key: 'Permissions-Policy', value: 'camera=(), microphone=(), geolocation=(self)' },
          {
            ...
            value: [
              ...
              "img-src 'self' data: blob: https://*.ytimg.com https://*.instagram.com https://*.cdninstagram.com https://images.unsplash.com https://*.public.blob.vercel-storage.com https://unpkg.com https://tile.openstreetmap.org",
